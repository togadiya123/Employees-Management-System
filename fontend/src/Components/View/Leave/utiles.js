...
export const getLeaveInformationModalBodyFormData = ({
    ...
    [{
        ...
        validationType: ``,
        required: true,
        value: moment(applicationDate).format(config.REGULAR_DATE_TIME_FORMAT) || ``,
        size: 'small',
        helperText: ``,
        isValid: true,
        isInitialValue: false,
    ...
    [{
        ...
        validationType: `date`,
        required: true,
        value: moment(startingDate).format(config.REGULAR_DATE_TIME_FORMAT) || ``,
    ...
    [{
        ...
        validationType: `date`,
        required: true,
        value: moment(endingDate).format(config.REGULAR_DATE_TIME_FORMAT) || ``,
...
export const userEditOption = () => [
    {
        ...
        format: (e) => moment(e, config.REGULAR_DATE_TIME_FORMAT).format(config.DEFAULT_DATE_FORMAT),
